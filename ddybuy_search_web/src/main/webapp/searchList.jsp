...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script type="text/javascript">
        ...
        jq(function () {//加载事件
            //页面一加载就显示用户信息
            jq.post("http://localhost:8033/getUserName",{"token":readCookie("token")},function(data){
                if (data.result==""||data.result==null){
                    jq("#showname").html("你好,<a href='http://localhost:8033/login'>请登录</a>");
...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	 <span class="fl"><span id="showname" style="color:#ff4e00;"></span>&nbsp; <a href="http://localhost:8033/Regist.jsp" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                    <c:forEach items="${map.rows}" var="p">
                        <li>
                            <div class="img"><a target="_blank" href="http://localhost:80/${p.pid}.html"><img src="images/123.jpg" width="210" height="185" /></a></div>
                            <div class="price">
